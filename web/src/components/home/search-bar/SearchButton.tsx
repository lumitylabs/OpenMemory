export function SearchButton(props: any) {
  ...
  const buttonClasses = `font-Muda font-semibold select-none transition duration-300 ease-in-out font-regular text-[#000] px-2 rounded-full flex gap-4 items-center ${
